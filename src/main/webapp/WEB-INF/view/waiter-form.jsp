...
<head>
    ...
    <title>
        <fmt:message key="waiter.form.page.title"/>
    </title>
    <meta charset="utf-8">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="text-center mb-3">
                    <fmt:message key="waiter.form.title"/>
                </h5>
                <form:form action="/admin/waiter/save" modelAttribute="waiter" method="post">
                    ...
                    <div class="mb-2">
                        <label for="restaurantTableList" class="form-label">
                            <fmt:message key="label.table.list.colon"/>
                        </label>
